...
if __name__ == "__main__":
    ...
    input_example =[
        "Android is a mobile operating system based on kerolos which is a modified version of the Linux kernel designed primarily for mobile devices",
        "Pizza is a great food",
        "this is a boy called Kirolos",
        "Android is developed , with the main contributor",
        "Android code has been used as the basis of different system",
